   <form action="enviar.php" method="post">
      <div id="homeToolbar">
        <div class="b728x90">
         ...
         <div class="left">
            <div class="paste_option" id="pasteTitle" original-title="Indica un titulo para tu paste">
               ...
               <div class="paste_optd">
                  <input class="rounded" type="text" id="paste_title" name="titulo" value="">
               </div>
               <div class="clear"></div>
            </div>
         ...
         <div class="left">
           <img src="images/rte-bold.png" class="cursor" onclick="rteSimple(&quot;b&quot;);" alt="BOLD">
           <img src="images/rte-italic.png" '="" class="cursor" onclick="rteSimple(&quot;i&quot;);" alt="ITALIC">
           <img src="images/rte-underlined.png" '="" class="cursor" onclick="rteSimple(&quot;u&quot;);" alt="UNDERLINE">
           <img src="images/rte-strike.png" '="" class="cursor" onclick="rteSimple(&quot;s&quot;);" alt="STRIKE">
 <img src="images/rte-link-button.png" class="cursor" onclick="rteLink();" alt="LINK" title="Insertar link">
 <img src="images/rte-image-button.png" class="cursor" onclick="rteImage();" alt="IMG" title="Insertar Imagen"> 
      
           <div class="rte-menu" onclick="rteMenu('colors', this);" title="Change Color">Colors &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/icon_open.gif" alt="V"></div>
           ...
           <div class="rte-menu" onclick="rteMenu('sizes', this);" title="Change Font Size">Sizes &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/icon_open.gif" alt="V"></div>
         ...
         <div class="right">
           <img class="cursor" alt="Preview Paste" src="images/preview.png" id="preview">
         </div>
         <div class="clear"></div>
      </div>
      
      <div id="_pastebox">
         <textarea cols="112" rows="15" class="pastebox rounded" name="paste" id="input_text"></textarea>
      </div>
      ...
      <div class="padTop10"></div>
            <div class="paste_option " id="passwordOpt" original-title="Protege tu Paste con un Password para fisgones">
               ...
               <div class="paste_optd"><input type="text" class="rounded" id="paste_password" name="pass" value=""></div>
               <div class="clear"></div>
            </div>
